...
public class TwoVBattery extends Product {
    ...
    public TwoVBattery(Integer productId, String productName, String modelName, String brandName, int voltage, String imageMainUrl, String imageOneUrl, String imageTwoUrl, String imageThreeUrl, float mrp, float discountPercentage, int stock, ProductType productType, float rebate, int guarantee, int warranty, String series, int ah, String terminalLayout) {
