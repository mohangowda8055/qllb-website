...
public class FourVBattery extends Product {
    ...
    @ManyToMany(mappedBy = "fourVBatteries", cascade = {CascadeType.DETACH, CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH})
    private List<FourVModel> fourVModels;

    @ManyToMany(mappedBy = "fourVBatteries", cascade = {CascadeType.DETACH, CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH})
    private List<FuelType> fuelTypes;

    public FourVBattery(Integer productId, String productName, String modelName, String brandName, int voltage, String imageMainUrl, String imageOneUrl, String imageTwoUrl, String imageThreeUrl, float mrp, float discountPercentage, int stock, ProductType productType, float rebate, int guarantee, int warranty, String series, int ah, String terminalLayout) {
