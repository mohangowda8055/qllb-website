...
const ThreeWheelerSearch = ({ brands }) => {
  ...
  const { threeVProductList } = useSelector((state) => state.productState);
    ...
    <section className="bg-white min-h-80">
      ...
      <div ref={scrollToRef}>
        ...
        {isBatteriesLoading ? (
          ...
          threeVProductList.length > 0 ? (
            <ProductList
              products={threeVProductList}
...
export default ThreeWheelerSearch;
